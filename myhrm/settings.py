"""
Django settings for myhrm project.
...
SECRET_KEY = 'django-insecure-9+^%md@)rhj$@5gua=7oz0013mq$d!bxdx2m*ak(*9%u4a@w$c'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'employees.context_processors.admin_notifications',
                'employees.context_processors.global_notifications',
            ],
        },
    },
]

WSGI_APPLICATION = 'myhrm.wsgi.application'
...
try:
    ...
    smtplib.ssl.create_default_context = _create_unverified_https_context
